    ...
    this.showRow = !this.showRow;
       ...
       columns = [
        ...
        // { label: 'Duration (Minutes)', fieldName: 'Duration_Min__c', type: 'Number' },
         { label: 'Labour Category', fieldName: 'RR_Labour_Category__c', type: 'Number' },
        { label: 'Labour charge', fieldName: 'Labour_Charge__c', type: 'currency',  cellAttributes: { alignment: 'left' }  },
        // {label:'Action',
        //     type: 'button',
        //     typeAttributes: {
        //         label: 'Delete',
