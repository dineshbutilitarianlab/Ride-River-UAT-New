...
export default class RideRiverWarrantyRecord extends LightningElement {
    ...
    partsColumns = [
        ...
        { 
            ...
            type: 'url', editable: this.isFFIRLinksEditable,
    ...
    get buttonLabel() {
        return this.isApprovalFired ? 'Approval Process Already Initiated' : 'Submit For Approval';
    }
    ...
    handleAction(event) {
        ...
        .then(() => {
         ...
         .then(() => {
            ...
            this.showToast('Success', `${action.charAt(0).toUpperCase() + action.slice(1)} action performed successfully, with ASM Feedback updated.`, 'success');
